...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        ImGui::Begin("System Resource Monitor", nullptr, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);

        ImGui::TextColored(ImVec4(0, 1, 1, 1), "SYSTEM RESOURCE MONITOR");
        ImGui::Separator();
